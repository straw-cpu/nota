...
<p align="center">
  <img src="examples/alg_lecture10/images/L10-default.png" alt="代数基础 Lecture 10 — Default 主题" width="36%">
  <img src="examples/alg_lecture10/images/L10-dark.png" alt="代数基础 Lecture 10 — Dark 主题" width="36%">
</p>

<p align="center">
  <em>Default 主题（左）· Dark 主题（右）— <code>/notes-theme</code> 一键切换</em>
</p>

| 主题版本 | 链接 |
|---|---|
| Default 主题 | [`examples/alg_lecture10/alg_lecture10-default.html`](https://straw-cpu.github.io/nota/examples/alg_lecture10/alg_lecture10-default.html) |
| Dark 主题 | [`examples/alg_lecture10/alg_lecture10-dark.html`](https://straw-cpu.github.io/nota/examples/alg_lecture10/alg_lecture10-dark.html) |

---

### 文献阅读：广义预测控制 GPC Part I

*Clarke et al., Automatica 1987* — 经典预测控制论文，12 页，通过 `/notes-split` + `/notes-new` 两步生成。

工作流：`/notes-split lecture.pdf --pages 5` → 拆成 3 块 → `/notes-new` 逐块生成 → 合并为完整笔记。

涵盖：CARIMA 模型推导 · Diophantine 递推 · 控制律矩阵形式 · 控制时域分析 · 与 GMV/DMC/EPSAC 对比表 · 仿真研究 · 附录数值示例，所有推导步骤放折叠块，思考题自动生成。

<p align="center">
  <img src="examples/gpc_part1/images/GPC_Clarke.png" alt="GPC Part I 笔记截图" width="36%">
</p>

<p align="center">
  <em>12 页论文 → 含公式、对比表、折叠 Q&amp;A 的交互式 HTML（820 行）</em>
</p>
...
克隆后将 `skills/` 目录指向你的 agent，六个 skill 即可使用：

| Skill | 触发方式 | 功能 |
|---|---|---|
| `notes-split` | `/notes-split` | 把 PDF 按指定页数拆成若干小块，输出到 `splits/` 子目录，作为 `/notes-new` 的前置步骤 |

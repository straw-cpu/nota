...
**系统辨识 → 理论推导 → 校核 → 仿真验证 → 工程实现（C++）**

<p align="center">
  <img src="examples/water_tank_gpc/images/arx_identification.png" alt="ARX 系统辨识" width="32%">
  <img src="examples/water_tank_gpc/images/gpc_sim.png" alt="GPC 仿真实验" width="32%">
